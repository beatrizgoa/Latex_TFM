...
def evaluate_lenet5(learning_rate=0.0005, n_epochs=400, nkerns=[96, 256, 386, 384, 256], batch_size=25):
    ...
    print ('In the architecture conv, pool, response normalization,fully connect, dropout and softmax layers are used with relu.')
    print ('The configuration of the net is learning_rate=0.001, n_epochs=200, nkerns=[96, 256, 386, 384, 256], batch_size=20')
    print ('Patience has been increased from patience = 10000 to patience = 100000 ')
    ...
    layer8 = LogisticRegression(input=layer7.output, n_in=4000, n_out=2)
