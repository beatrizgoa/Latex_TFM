...
\begin{tabular}[c]{@{}c@{}}SVM - RBF\\ C = X\end{tabular}               & V    & V    & \begin{tabular}[c]{@{}c@{}}SVM - RBF\\ C = X\end{tabular}                  & V    & V    & \begin{tabular}[c]{@{}c@{}}SVM - RBF\\ C = X\end{tabular}                  & V    & V    \\ \hline
\begin{tabular}[c]{@{}c@{}}SVM - lineal\\ C = X\end{tabular}            & V    & V    & \begin{tabular}[c]{@{}c@{}}SVM - lineal\\ C = X\end{tabular}               & V    & V    & \begin{tabular}[c]{@{}c@{}}SVM - lineal\\ C = X\end{tabular}               & V    & V    \\ \hline
\begin{tabular}[c]{@{}c@{}}KNN\\ k = x\end{tabular}                     & V    & V    & \begin{tabular}[c]{@{}c@{}}KNN\\ k = x\end{tabular}                        & V    & V    & \begin{tabular}[c]{@{}c@{}}KNN\\ k = x\end{tabular}                        & V    & V    \\ \hline
\begin{tabular}[c]{@{}c@{}}Decision Tree\\ Depth =\end{tabular}         & V    & V    & \begin{tabular}[c]{@{}c@{}}Decision Tree\\ Depth =\end{tabular}            & V    & V    & \begin{tabular}[c]{@{}c@{}}Decision Tree\\ Depth =\end{tabular}            & V    & V    \\ \hline
