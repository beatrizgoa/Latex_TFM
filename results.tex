...
\rowcolor[HTML]{ECF4FF}
{\color[HTML]{333333} \textbf{CNN model}} & {\color[HTML]{333333} \textbf{EER(\%)}} & \textbf{CNN model}      & \textbf{EER}     \\ \hline
Own model CASIA Video proposed  &                             &  Own Model proposed MFSD-MSU database &                                  \\ \hline
0wn model CASIA images proposed   &                            &                                        &                                  \\ \hline
CNN architecture proposed in \cite{LSTM-CNN} &           6,2     &                                        &                                  \\ \hline
LSTM-CNN architecture proposed in \cite{LSTM-CNN} &      5,17    &                      &                  \\ \hline
CNN architecture proposed in \cite{yangLL14} &      4,64          &                      &                  \\ \hline
