...
\begin{figure}[htb]
\centering
\includegraphics[width=0.65\textwidth]{images/FAR-FRR/Casia_vid_LDA_SVM_RBF_FAR_FRR.png}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.65\textwidth]{images/FAR-FRR/FRAV_LDA_SVM_RBF_FAR_FRR.png}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.65\textwidth]{images/FAR-FRR/FRAV_clas_LDA_SVM_RBF_FAR_FRR.png}
\caption{FAR-FRR curve of RGB+NIR FRAV database using LDA and SVM (RBF kernel).} \label{fig:RGB_FRAV_clas_FAR_FRR}
\end{figure}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.65\textwidth]{images/FAR-FRR/MFSD_SVM_RBF_FAR_FRR.png}
