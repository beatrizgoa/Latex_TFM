...
From figure \ref{fig:LenetModifications}, also can be conclude that the training and validation processes in others experiments behaviour similar as original LeNet-5 performance.\\
