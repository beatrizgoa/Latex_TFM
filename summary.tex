...
Authors from \cite{yangLL14} describe lightly the architecture, the parameters and the changes made from Imagenet, so it is not possible to develop an architecture based on the utilized in the article \cite{yangLL14}, therefore, it is going to be based on Imagenet.\\
