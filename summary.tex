...
\begin{figure}[htb]
\centering
\subfigure[Cost]{\includegraphics[width=0.48\textwidth]{images/ModificandoLenet/lenet_frav_cost.png}\label{Lenet_FRAV_cost} }
\subfigure[Error]{\includegraphics[width=0.48\textwidth]{images/ModificandoLenet/lenet_frav_error.png \label{Lenet_FRAV_error}}

\caption{Cost at training (a) and Error at validation (b) when LeNet has been used with RGB FRAB database.}
