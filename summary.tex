...
\cline{2-6}
& \cellcolor[HTML]{ECF4FF}\begin{tabular}[c]{@{}c@{}}RGB\\ FRAV\end{tabular} & \cellcolor[HTML]{ECF4FF}\begin{tabular}[c]{@{}c@{}}RGB+NIR \\ FRAV\end{tabular} & \cellcolor[HTML]{ECF4FF}\begin{tabular}[c]{@{}c@{}}CASIA \\ images\end{tabular} & \cellcolor[HTML]{ECF4FF}\begin{tabular}[c]{@{}c@{}}CASIA\\ videos\end{tabular} & \cellcolor[HTML]{ECF4FF}MFSD-MSU \\ \hline
