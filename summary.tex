...
\subsection{LeNet-5 and face database}
...
In figure \ref{fig:FRAV_two}, the validation error in each epoch could be visualized using two classes to classify. It could be seen that in each epoch the validation error is the same. Test error performance at the first epoch is 23.2 \%. The total time of the running has been 64.0167 minutes.\\
...
The time in both cases, classifying with two or five classes, is similar. The result is better when just two classes are used and no differentiation is made among attacks. There would be need more samples and more time to get a better score if five classes classification is wanted. Also, the architecture should be adapted to this problem.\\
...
\cline{2-6}
                                                                       & \cellcolor[HTML]{ECF4FF}RGB FRAV & \cellcolor[HTML]{ECF4FF}RGB + NIR FRAV & \cellcolor[HTML]{ECF4FF}CASIA images & \cellcolor[HTML]{ECF4FF}CASIA videos & \cellcolor[HTML]{ECF4FF}MFSD \\ \hline
\multicolumn{1}{|c|}{\cellcolor[HTML]{ECF4FF}Nº train samples class 0} & 157                              & 133                                    & 26                                   & 255                                  & 30                           \\ \hline
\multicolumn{1}{|c|}{\cellcolor[HTML]{ECF4FF}Nº train samples class 1} & 459                              & 417                                    & 111                                  & 81                                   & 68                           \\ \hline
\multicolumn{1}{|c|}{\cellcolor[HTML]{ECF4FF}Nº valid samples class 0} & 10                               & 8                                      & 7                                    & 105                                  & 2                            \\ \hline
\multicolumn{1}{|c|}{\cellcolor[HTML]{ECF4FF}Nº valid samples class 1} & 83                               & 70                                     & 13                                   & 39                                   & 12                           \\ \hline
\multicolumn{1}{|c|}{\cellcolor[HTML]{ECF4FF}Nº test samples class 0}  & 19                               & 16                                     & 16                                   & 540                                  & 3                            \\ \hline
\multicolumn{1}{|c|}{\cellcolor[HTML]{ECF4FF}Nº test samples class 1}  & 167                              & 70                                     & 23                                   & 180                                  & 25                           \\ \hline
