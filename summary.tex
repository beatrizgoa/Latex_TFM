...
The architecture utilized in the final, and the most important experiment is described in this section. This architecture is like the presented in section \ref{subsec:ejecucion1} and it is going to be explained in detail.\\
