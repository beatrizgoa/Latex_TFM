...
The output of the CNN is the input of the classifiers. The classifiers that are going to be trained and tested are KNN, SVM, Decision Tree and Logistic regression. Also, reduction algorithm methods as LDA and PCA are used with each classifier.\\
