...
Python has been used to succeed with the objective of the thesis as the programming language. Theano has been preferred as the main library to develop the architecture of the Convolutional Neural Network and training and testing processes.\\
