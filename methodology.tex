...
\begin{figure}[tb]
\centering
\subfigure[Subsets generator diagram]{\includegraphics[width=0.18\textwidth]{images_miscelaneus/Databases_gen.png}\label{fig:dat_flowchart} }
\subfigure[General algorithm diagram]{\includegraphics[width=0.62\textwidth]{images_miscelaneus/Algorithm.png} \label{fig:alg_flowchart} }
