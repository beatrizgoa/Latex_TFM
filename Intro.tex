...
The desire of working in a anti-spoofing problem was incremented if the problem is real, that is now starting to being implemented and I could contribute with my knowledge to the investigation.\\
...
With the purpose of knowing the advances in this thesis field, a literature review is detailed in chapter \ref{ch:review}.
