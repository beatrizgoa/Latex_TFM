...
One neural network is defined by its type of layers and the number of neurons, also, there are parameters that also affect to the behavior of the network (learning rate,...)\cite{Lecum2}.\\
